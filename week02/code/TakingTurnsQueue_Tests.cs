...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Not adding poeple to end of queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim had (0) turns when he should have had infinite.
    //   The GetNextPerson function didn't account for (0 or negative).
